...
namespace WebSearchShortcut.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Maximum number of queries to keep for each shortcut. Older entries are deleted automatically when the limit is exceeded. Set to 0 to keep none (disable history)..
        /// </summary>
